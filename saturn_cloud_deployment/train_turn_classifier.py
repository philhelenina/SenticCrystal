"""
Turn-level Classifier Training (K=2,4,6,8,10,15,20 Forward-only Context)
========================================================================
...
from classifiers import SimpleLSTM, MLP, FocalLoss, EarlyStopping, DEFAULT_CONFIG, ContextMLP
...
def main():
    ...
    parser.add_argument('--k_value', type=int, required=True, choices=list(range(1, 101)), 
                       help='Context window size (1-100)')
...
# python train_turn_classifier.py --config_id 146 --k_value 8 --model both
# python train_turn_classifier.py --config_id 146 --k_value 10 --model lstm
# python train_turn_classifier.py --config_id 146 --k_value 15 --model mlp
# python train_turn_classifier.py --config_id 146 --k_value 20 --model both