...
# -*- coding: utf-8 -*-
"""
train_npz_hier_classifier_4way_v2.py
...
DEFAULT_EMB_ROOT = HOME / "data" / "embeddings" / "4way" / "sentence-roberta-hier"
...
def load_labels(split: str, label_col: str, user_map: dict):
    path = DATA_DIR / f"{split}_4way_unified.csv"
    df = pd.read_csv(path)
...
def main():
    ...
    ap.add_argument("--expected_labels", nargs="*", type=int, default=[0,1,2,3])
